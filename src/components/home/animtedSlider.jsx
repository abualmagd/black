...
export function AnimatedSlider(){
    ...
    return <div className="animated-slider-wrapper overflow-hidden h-16 w-screen bg-base-300  mt-6 md:-mx-20 flex flex-col items-start justify-center">
<motion.div
...
{/*render duplicted list*/}
{
    duplictedSlides.map((s,i)=>{
        ...
        return <div key={i}  className="flex-shrink-0 " style={{width:`${100/times}%`}}>
