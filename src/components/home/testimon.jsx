...
export function Testimonial({data,readMore}){
    ...
    return <section className="bg-base-100 mb-10 mt-8">
  ...
  {data.map((t,index)=>{
     ...
     {readMore&& <a href="/reviews" className=" btn btn-outline btn-wide text-center mt-3 hover:scale-105 border-solid border-2 border-gray-200   ">Show more reviews</a>}
...
export function Tesmini({object}){
  ...
  return    <blockquote className="rounded-lg bg-base-300 p-6 shadow-sm sm:p-8 m-2">
  <div className="flex items-center gap-4">
    ...
    <div>
      ...
      <a href={object.url} rel="nofollow" className="mt-0.5 text-lg font-medium text-gray-900 capitalize">{object.name}</a>
    </div>
  </div>
